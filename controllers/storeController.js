...
async function getLoyaltyProgramDetails(req, res) {
  try {
    ...
    return res.status(200).json({
      message:
        'Loyalty program details fetched successfully',
      ...
      loyaltyProgram: {
        ...
        vendor: {
          ...
          profilePicture:
            vendorProfile?.profilePicture || null,

          address: {
            streetAddress:
              vendorProfile?.streetAddress || null,

            city:
              vendorProfile?.city || null,

            state:
              vendorProfile?.state || null,

            country:
              vendorProfile?.country || null,

            pincode:
              vendorProfile?.pincode || null,
          },
        },
      },
    });
    ...
    console.error(
      'Get loyalty program details error:',
      error
    );
